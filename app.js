document.addEventListener('DOMContentLoaded', () => {
    ...
    // Define the first tetromino based in random position in the array
    ...
    //freeze function
    function freeze() {
        let found = current.some( index => squares[currentPosition + index + width].classList.contains('taken') );
